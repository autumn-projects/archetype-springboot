...
import com.oscroll.configuration.handler.*;
import com.oscroll.domain.user.UserService;
import com.oscroll.util.security.JwtTokenUtil;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        ...
        //需要将密码加密后写入数据库
        // userService 类中获取了用户的用户名、密码以及是否启用的信息，查询用户所授予的权限，用来进行鉴权，查询用户作为群组成员所授予的权限
